...
function ProjectCard({ project, index }: { project: typeof projectsConfig.items[number]; index: number }) {
  const content = (
    <>
  ...
  const className = "relative flex flex-col items-stretch duration-300 ease-out p-7 sm:p-3 group h-100 rounded-2xl";
